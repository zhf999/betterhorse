...
public class EntityRegistryHandler {
    ...
    {
        FabricDefaultAttributeRegistry.register(COMMONHORSE, CommonHorseEntity.createCommonHorseAttributes());
        ...
        FabricDefaultAttributeRegistry.register(NETHER_HORSE, NetherHorseEntity.createCommonHorseAttributes());
